...
<body class="signup-body">
    <nav>
        <a href="index.php" class="logo"><svg fill="#000000" height="50px" width="50px" version="1.1" id="Layer_1"
        ...
        <div class="nav-icon-container">
            <ion-icon href="user.html" name="person-circle-outline" onlick="redirectUser()" id="btn-userpage"
                size="large"></ion-icon>
            <ion-icon hrer="cart.html" name="cart-outline" onclick="redirectCart()" id="btn-cart"
                size="large"></ion-icon>
        </div>
        ...
        <div class="form signup">
            <div class="form-content">
                ...
                <form action="register.php" method="post">
                    ...
                    <div class="field button-field">
                        <button type="submit" value="Register">Registrer</button>
                    </div>
                </form>
                <div class="form-link">
